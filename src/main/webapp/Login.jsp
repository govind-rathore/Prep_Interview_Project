...
<body>
    ...
    <div class="flex flex-wrap w-full">
        <div class="flex flex-col w-full md:w-1/2">
            <div class="flex justify-center pt-12 md:justify-start md:pl-12 md:-mb-24">
                <a href="#" class="p-4 text-xl font-bold text-white bg-black"> Design. </a>
            </div>
                ...
                <form class="flex flex-col pt-3 md:pt-8" action="login" method="post">
                    ...
                    <div class="flex flex-col pt-4">
                        <div class="flex relative ">
                            ...
                            </span> <input type="text" name="email" id="design-login-email"
                    ...
                    <div class="flex flex-col pt-4 mb-12">
                        <div class="flex relative ">
                            ...
                            </span> <input type="password" name="password" id="design-login-password"
                                class=" flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
    ...
    <%--    <input type="hidden" name="topicId" value="<%=request.getParameter("topicId") != null ? request.getParameter("topicId") : "" %>">
                ...
                <div class="pt-12 pb-12 text-center">
                    <p>
                        Don&#x27;t have an account? <a href="#" class="font-semibold underline"> Register here. </a>
                    </p>
                </div>
            </div>
        </div>
